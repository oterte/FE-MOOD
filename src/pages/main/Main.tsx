...
const Main = () => {
  ...
  return (
    <Wrap>
      <FirstContainWrap id="section1">
        <StyledTitle style={titleAnimation}>MOOD</StyledTitle>
      ...
      <div>
        <Element name="section2" id="section2">
          ...
          <SecondContain id="section2">
            ...
            <ComposerDesc>
              ...
              인생을 피아노에 바쳤고, 피아니스트들은 그를 피아노의 절대신이라고
        ...
        <Element name="section4" id="section5">
          <SecondContain>
            ...
            <ComposerDesc>
              ...
              작곡가이며 음악 역사상 크나큰 업적을 이룩한 작곡가로 평가받습니다.
              게다가 음악가에게 사형선고나 다름없는 청각장애를 딛고 위대한
              유산을 일구었기 때문에 불굴의 의지와 인간승리를 상징하는 인물로
              유명합니다. 그의 음악에서도 이러한 고뇌와 인생 역전의 분위기가 잘
              드러납니다.
            </ComposerDesc>
            <RepresentativeSong>
              <Hr />
